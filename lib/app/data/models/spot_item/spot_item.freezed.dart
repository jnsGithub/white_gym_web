...
// required int? monthly,              // 개월 수
  ...
  @override
  String toString() {
    return 'SpotItem(documentId: $documentId, name: $name, descriptions1: $descriptions1, descriptions2: $descriptions2, price: $price, discountCheck: $discountCheck, beforeDiscount: $beforeDiscount, admission: $admission, index: $index, isSubscribe: $isSubscribe, pause: $pause, locker: $locker, daily: $daily, passTicket: $passTicket, sportswear: $sportswear, spotDocumentId: $spotDocumentId, createDate: $createDate)';
  }
}
