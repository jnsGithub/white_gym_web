              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => Column(
                      ...
                      children: [
                        Text('소속 지점', style: TextStyle(fontSize: size.width * 0.0104, fontWeight: FontWeight.w500, color: gray700),),DropdownButtonHideUnderline(
                  ...
                  _inputField(hint: '휴대폰 번호', controller: controller.hpController, isPassword: false, size: size),
      ...
      children: [
        Checkbox(
          ...
          onChanged: (value) {
            ...
            print(controller.selectedTye.value);
            if(controller.selectedTye.value != 3){
              if(controller.selectedSpotIdList.isNotEmpty){
